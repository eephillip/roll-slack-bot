...
app.post('/command', (req, res) => {
    ...
    if (signature.isVerified(req)) {
        ...
        async.series([
            next => {
                ...
                if (text === "" || text === "help") {
                    ...
                    if(text.includes('ability')) {
                        ...
                        response.message.text = 'Ability Roll *4d6b3 x 7* Drop Lowest';
                        response.message.attachments = ability.roll('');
                        next(null);
            ...
            debug(util.inspect(response.message, { depth:null, breakLength: Infinity, manArrayDepth: null }));
